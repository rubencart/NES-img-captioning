...
#
#     # necessary?? yes because ES estimates gradients (openAI paper)
#     # todo check if args theta, **exp are still right (probably not)
...
#         tslimit, incr_tslimit_threshold, tslimit_incr_ratio, tslimit_max = \
#             config.episode_cutoff_mode, None, None, config.episode_cutoff_mode
...
#             'The maximum timestep limit is {}'.format(
