...
def import_algo(name):
    ...
    if name == 'ga':
        import algorithm.ga_master as algo
    # elif name == 'rs':
...
if __name__ == '__main__':
    master(algo='ga', master_socket_path='/tmp/es_redis_master.sock', exp_file='experiments/mnist_ga.json', plot=True,
           exp_str=None, log_dir=None)
