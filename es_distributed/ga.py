...
def run_master(master_redis_cfg, log_dir, exp):
    ...
    while True:
        ...
        # todo while condition should now be while EOS not reached right?
        ...
        # todo this is tensorflow specific I think? pytorch: .train() <-> .eval()
...
def run_worker(master_redis_cfg, relay_redis_cfg, noise, *, min_task_runtime=.2):
    ...
    while True:
        ...
        # todo check paper for eval_prob???
